...
export function SupplierSummary({
  ...
  return el(
    ...
    el("span", { className: "summary-label" }, "Deuda Total Estimada"),
    el(
      "div",
      { className: "summary-amount-row" },
      el(
        "h1",
        { className: "summary-total" },
        SupplierModel.formatAmount(totalAmount, isVisible)
      ),
      el("button", {
        className: "btn-visibility",
        onclick: onToggleVisibility,
        innerHTML: isVisible ? eyeSVG : eyeOffSVG,
      })
    )
  );
}
